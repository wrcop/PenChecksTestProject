...
- Create Angular project with ng: `ng new pencheckstest.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`pencheckstest.client.esproj`).
